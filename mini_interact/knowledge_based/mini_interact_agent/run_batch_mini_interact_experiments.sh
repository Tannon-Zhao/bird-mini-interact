...
# Default settings
DATA_PATH="../data/bird-interact-full-mini/bird_interact_data.jsonl"
MINI_INTERACT=true
...
DEBUG=false # Set to true to debug the `sol_sql` could be submitted successfully
...
while (( "$#" )); do
  case "$1" in
    ...
    --mini_interact) MINI_INTERACT=true; shift ;;
